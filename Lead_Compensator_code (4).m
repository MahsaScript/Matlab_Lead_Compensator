...
% G(s)=1/s^2-s-2 to satisfy the following specifications 
% (i) The phase  margin of the system =45 degrees, 
%  The gain cross-over frequency of the system must be less than 16.3 rad /sec. 
 
%% Design a Lead compensator for the given open-loop system such that the closed-loop system
%with negative unity feedback has overshoot less than 16.3% and settling time less than 2
%seconds.
%(a) In the first design, consider placing the compensator zero at s = −z = −1 to cancel out
%the stable pole of the open-loop system.
...
Pmd=45;                       % Desired Phase Margin (PM)
